using static JavaInRubyTranslator.AssignmentRules;
using static JavaInRubyTranslator.FunctionRules;
using static JavaInRubyTranslator.IfLoopRules;
using static JavaInRubyTranslator.NewVariableRules;
using static JavaInRubyTranslator.SyntaxGlobals;
