namespace JavaInRubyTranslator
{
    /*
         * ----------------------------------------------------------------------------------------
         * ----------------------------------Генератор кода----------------------------------------
         ...
         * Ruby. Дерево, построенное синтаксическим анализатором используется, чтобы перевести
         * входную программу на Java в программу на Ruby при помощи таблицы соотвествия.
         * 
         * ----------------------------------------------------------------------------------------
         * 
        ...
        static string Translate(List<TreeNode> treeNodes, ref int i, int size) {
            ...
            switch (treeNodes[i].lexem.type)
            {
                ...
                case "K9":
                    ...
                    intOffset--;
                    return "while(" + whileConditionString + ") do\n" + whileBodyString;
                ...
                case "K11":
                    ...
                    // Начальное условие, его надо отдельно записать, ибо Ruby...
                ...
                // ++
                case "U1":
                    //В Ruby нет "++", поэтому заменим на скобку - ++a -> (a + 1)
                    i++;
